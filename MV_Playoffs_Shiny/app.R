...
get_history_plot <- function(historydf, var_to_plot){
  ...
  color_palette = c('#666666', '#000000', '#FF6666', '#006600',
                    '#0033FF', '#660066', '#663300', '#FFCC00',
                    '#FF9966', '#66FF33', '#3399FF', '#FF0033')
...
ui <- fluidPage(
    ...
    mainPanel(
      h2("Takes 12 To Tango 2019 Playoff Predictions", align = 'center'),
              ...
              tabsetPanel(
                tabPanel(paste("Thru Week",toString(WEEK)), div(DT::dataTableOutput("preds2019"),
                ...
                h4("How these predictions work:", align = 'center'),
